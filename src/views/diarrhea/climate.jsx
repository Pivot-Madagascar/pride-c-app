...
const DiarrheaClimate = () => {
    ...
    const diarrhea_2018Data = useSelector((state) => state.diarrhea.diarrhea_2018)
    const diarrhea_2017Data = useSelector((state) => state.diarrhea.diarrhea_2017)
    ...
    const diarrheaChartData = useMemo(() => {
        return {
            labels,
            datasets: [
                {
                    ...
                    data: [diarrhea_2017Data, diarrhea_2018Data, diarrhea_2017Data],
            ...
            <div className={style.climateContent}>
                ...
                { selected.includes(precipitation.id) &&
                    <PrecipitationChart
                        ...
                        adminDivisionType={adminDivisionType}
                        colorTheme={COLORS.green_lighter}
                    />
                }
