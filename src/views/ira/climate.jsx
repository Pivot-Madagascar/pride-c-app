...
const IraClimate = () => {
    ...
    const ira_2018Data = useSelector((state) => state.ira.ira_2018)
    const ira_2017Data = useSelector((state) => state.ira.ira_2017)
            ...
            datasets: [
                {
                    ...
                    data: [ira_2017Data, ira_2018Data, ira_2017Data],
